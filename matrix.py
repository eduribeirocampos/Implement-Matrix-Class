...
class Matrix(object):
    ...
    def inverse(self):
        ...
        if self.w == 2:
            ...
            im = zeroes(self.w, self.h)
            im[0][0] = self.g[1][1] * (1/self.determinant())
            im[0][1] = -self.g[0][1] * (1/self.determinant())
            im[1][0] = -self.g[1][0] * (1/self.determinant())
            im[1][1] = self.g[0][0] * (1/self.determinant())
